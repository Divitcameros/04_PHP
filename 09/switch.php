    ...
    <form action="" method="post">
      <p>
        <select name="item">
          ...
          <!-- switch文で条件を指定する場合 -->
          <option value="キウイ" <?php switch($item) {case 'キウイ': echo 'selected';} ?>>キウイ</option>
          <option value="いちご" <?php switch($item) {case 'いちご': echo 'selected';} ?>>いちご</option>
          <option value="スイカ" <?php switch($item) {case 'スイカ': echo 'selected';} ?>>スイカ</option>
        </select>
      </p>
